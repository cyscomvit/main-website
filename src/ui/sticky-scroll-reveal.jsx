...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[30rem] snap-y snap-mandatory justify-center space-x-20 overflow-y-auto scroll-smooth rounded-md p-5"
      ref={ref}
      ...
      <div className="relative flex items-start ">
        <div className="max-w-3xl">
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20 flex min-h-[28rem] snap-start snap-always items-center">
              ...
              <motion.p
                ...
                className={`mt-10 max-w-lg font-general ${textColor} opacity-80`}
              >
                {item.description}
              </motion.p>
              </div>
